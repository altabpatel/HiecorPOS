//
//  ShowDetailsIphoneVC.swift
//  HieCOR
//
//  Created by Hiecor on 20/06/19.
//  Copyright © 2019 HyperMacMini. All rights reserved.
//

import UIKit

class ShowDetailsIphoneVC: UIViewController {
...
extension ShowDetailsIphoneVC: UITableViewDelegate, UITableViewDataSource {
...
extension ShowDetailsIphoneVC: showDetailsDelegate {
