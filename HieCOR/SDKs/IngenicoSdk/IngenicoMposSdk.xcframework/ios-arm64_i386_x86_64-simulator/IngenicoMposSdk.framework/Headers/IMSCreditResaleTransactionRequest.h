...
/*!
 * This object contains information required for processing a re-sale on a credit sale transaction.
 */

@interface IMSCreditResaleTransactionRequest : IMSTokenizableSaleTransactionRequest
...
/*!
 * Constructs a credit re-sale request.
 * @param originalSaleTransactionID     id of the credit sale transaction to do a re-sale
 * @param amount                        re-sale amount
