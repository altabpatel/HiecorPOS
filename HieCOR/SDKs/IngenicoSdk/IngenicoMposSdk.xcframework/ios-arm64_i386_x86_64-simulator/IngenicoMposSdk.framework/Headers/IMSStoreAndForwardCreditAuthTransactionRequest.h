...
/*!
 * This object contains information required for stored credit auth transaction.
 */

@interface IMSStoreAndForwardCreditAuthTransactionRequest : IMSBaseStoreAndForwardTransactionRequest
