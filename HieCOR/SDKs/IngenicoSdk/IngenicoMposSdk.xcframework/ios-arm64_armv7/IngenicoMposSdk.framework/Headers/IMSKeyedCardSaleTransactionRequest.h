...
/*!
 * This object contains information required for keyed in card sale transaction.
 */

@interface IMSKeyedCardSaleTransactionRequest : IMSTokenizableSaleTransactionRequest
...
- (id _Nullable) initWithCard:(IMSCard * _Nonnull)card andAmount:(IMSAmount * _Nonnull)amount andProducts:(NSArray * _Nullable)products andLongitude:(NSString * _Nullable)gpsLong andLatitude:(NSString * _Nullable)gpsLal andTransactionGroupID:(NSString * _Nullable)transactionGroupID;
...
- (id _Nullable) initWithCard:(IMSCard * _Nonnull)card andAmount:(IMSAmount * _Nonnull)amount andProducts:(NSArray * _Nullable)products andClerkID:(NSString * _Nullable)clerkID andLongitude:(NSString * _Nullable)gpsLong andLatitude:(NSString * _Nullable)gpsLal andTransactionGroupID:(NSString * _Nullable)transactionGroupID;
