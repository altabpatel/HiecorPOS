...
@interface IMSCreditSaleAdjustTransactionRequest : IMSBaseSaleTransactionRequest

/*!
 * Transaction ID of the original sale or completed auth transaction generated by Ingenico Payment
 * Server.
 */
@property (nonatomic, strong) NSString * _Nonnull originalSaleTransactionId;

/*!
 * Constructs a sale request with fields that are common for all sale transaction requests.
 * @param originalSaleTransactionId     id of the previously requested sale or completed auth transaction
