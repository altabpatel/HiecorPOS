...
/*!
 * This object contains information required for credit auth transaction.
 */

@interface IMSCreditAuthTransactionRequest : IMSTokenizableSaleTransactionRequest
...
/*!
 * Constructs a card auth transaction request.
...
/*!
 * Constructs a card auth transaction request.
 * @param amount initial auth amount to withhold from the cardholder's account
