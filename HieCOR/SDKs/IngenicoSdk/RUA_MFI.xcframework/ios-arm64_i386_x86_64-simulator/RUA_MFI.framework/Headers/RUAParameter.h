...
typedef NS_ENUM(NSInteger, RUAParameter) {
    ...
    */
     ...
     */
    RUAParameterINTERAC_TAG_IC_FFI = 585,
    
    /**
      Card Transaction Information
     */
    RUAParameterINTERAC_TAG_IC_CTI = 586,
    
    /**
     Terminal Transaction Information
     */
    RUAParameterINTERAC_TAG_TERM_TTI = 587,
    
    /**
     Terminal Transaction Type
     */
    RUAParameterINTERAC_TAG_TERM_TTT = 588,
    
    /**
     Contactless floor limit
     */
    RUAParameterINTERAC_TAG_TERM_FLOORLMT = 589,
    
    /**
     Terminal Option Status
     */
    RUAParameterINTERAC_TAG_TERM_TOS = 590,
    
    /**
     Merchant Type Indicator
     */
    RUAParameterINTERAC_TAG_TERM_MTI = 591,
    
    /**
     Terminal Contactless Receipt Required Limit
     */
    RUAParameterINTERAC_TAG_RECEIPT_LMT = 592,
    
    /**
     Interac Receipt Status
     */
    RUAParameterINTERAC_TAG_RECEIPT_FLG = 593,
