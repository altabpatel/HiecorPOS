 ...
 */
- (void)clearAIDSList:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
 ...
 */
- (void)clearPublicKeys:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
...
/**
 ...
 @see PublicKey
 */
- (void)revokePublicKey:(RUAPublicKey * _Nonnull)key progress:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
 ...
 */
- (void)submitAIDList:(NSArray * _Nonnull)aids progress:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
...
/**
 ...
 @see RUAPublicKey
 */
- (void)submitPublicKey:(RUAPublicKey * _Nonnull)publicKey progress:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
...
/**
 ...
 @see ApplicationIdentifier
 */
- (void)submitContactlessAIDList:(NSArray * _Nonnull)aids progress:(OnProgress _Nonnull)progress response:(OnResponse _Nonnull)response;
...
- (void)setEnergySaverModeTime:(int)seconds res:(OnResponse _Nonnull)response;
...
- (void)setShutDownModeTime:(int)seconds res:(OnResponse _Nonnull)response;
 ...
 * @param response OnResponse block
 */
-(void)setApplicationSelectionFlag:(RUAApplicationSelectionOption)applicationSelectionOption response:(OnResponse _Nonnull)response;
