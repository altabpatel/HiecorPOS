...
class CentralManagerDelegate: NSObject, CBCentralManagerDelegate {
    ...
    //            return
    //        }
    //        guard  let isConnectable = advertisementData[CBAdvertisementDataIsConnectable] as? NSNumber,
    //            isConnectable == 1 else {
    //                return
    //        }
