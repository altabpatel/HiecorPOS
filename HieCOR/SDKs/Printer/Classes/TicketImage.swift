...
public struct TicketImage: BlockDataProviderForImage {
    
    private let image: Image
    private let attributes: [AttributeForImage]?
    
    public init(_ image: Image, attributes: [AttributeForImage]? = nil) {
        self.image = image
...
public extension TicketImage {
    ...
    enum PredefinedAttribute: AttributeForImage {
